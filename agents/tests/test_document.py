...
class TestBinaryDocumentToMarkdown:
    ...
    def test_document_path_to_markdown_with_unsupported_extension(self):
        """Test that an unsupported file extension raises a clear error."""
        with pytest.raises(ValueError, match="Unsupported file type"):
            document_path_to_markdown("document.txt")
